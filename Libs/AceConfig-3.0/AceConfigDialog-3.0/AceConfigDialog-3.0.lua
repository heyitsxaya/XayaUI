...
local function TreeOnButtonEnter(widget, event, uniquevalue, button)
	...
	-- BF fix (matches upstream Ace3): the loop guards intermediate nils
	-- but not the FINAL GetSubOption — hovering a tree node whose option
	-- was just removed (args rebuild, container deletion) passed nil into
	-- GetOptionsMemberValue → "attempt to index local 'option'".
	if not group then return end
